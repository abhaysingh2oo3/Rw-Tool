...
const UsersIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M23 21V19C23 18.1645 22.7155 17.3541 22.2045 16.7031C21.6935 16.0521 20.9877 15.5999 20.2 15.42" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
const MenuItem = ({ label, to, icon: Icon }) => (
  <NavLink
    to={to}
...
export default function Sidebar() {
  return (
    <aside className="sidebar">
      <div className="brand">
        <img src={logo} alt="Standard Chartered Logo" className="logo-img" />
        <span className="brand-text">Standard Chartered</span>
      </div>

      <nav className="nav">
        <MenuItem label="Dashboard" to="" icon={DashboardIcon} />
        <MenuItem label="User Management" to="users" icon={UsersIcon} />
        <MenuItem label="Access Control" to="access-control" icon={ShieldIcon} />
        <MenuItem label="Reports Management" to="reports" icon={ReportsIcon} />
        <MenuItem label="Settings" to="settings" icon={SettingsIcon} />
      </nav>
      ...
      <div className="profile">
        ...
        <div className="meta">
          ...
          <div className="email">abc@sc.com</div>
        </div>
      </div>
    </aside>
  );
